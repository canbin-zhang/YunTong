...
<body class="hold-transition skin-purple sidebar-mini">
			                ...
			                <div class="modal-dialog" role="document">
			                    <div class="modal-content">
			                        ...
			                        <div class="modal-body">
			                            <form id="form-search" action="${pageContext.request.contextPath}/Employee/employeeSearch?pageNum=1&pageSize=8" target="_blank" method="post">
    ...
    <script>
        ...
        $('#btn-refresh').click(function(){
        	 var num=$('#pageNum').val();
            const  url = "${pageContext.request.contextPath}/Employee/toEmployeeList?pageNum="+num+"&pageSize=8";
