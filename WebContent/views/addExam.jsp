...
<div class="wrapper">
	...
	<div class="content-wrapper">
		...
		<section class="content">	
				...
				<form action="${pageContext.request.contextPath}/Exam/addExam" method="post" enctype="multipart/form-data">
					
                            <!--基础控件-->
                            <div class="tab-pane active" id="tab-common">
                                <div class="row data-type">

                                    <div class="col-md-2 title">学生身份证</div>
                                    <div class="col-md-4 data">
                                    <div class="input-group">
										<span class="input-group-addon"><i class="fa fa-id-card-o fa-fw"></i></span>
                                        <input type="text" class="form-control" id="sid" name="sid" value="${student.sid}" readonly="readonly">
                                    </div>
									</div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="exam_lid" name="exam_lid" value="${student.lid}" readonly="readonly">
                                    </div>
                                    </div>

                                    <div class="col-md-2 title">科目</div>
                                    <div class="col-md-4 data">
                                        <div class="input-group">
									...
									<div class="col-md-2 title">考试日期</div>
                                    <div class="col-md-4 data">
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-calendar-o fa-fw"></i></span> 
										<input type="text" class="form-control" id="datepicker" name="exam_date" placeholder="请选择" required="required" >
									</div>
									</div>
									
									<div class="col-md-2 title">结果</div>
                                    <div class="col-md-4 data">
                                    <div class="input-group">
                                    ...
                                    <input type="hidden" id="eid" name="eid" value="${sessionScope.employee.eid}" />
                                    </div>
								</div>
                          </form>
					</div>
