...
<body class="hold-transition skin-purple sidebar-mini">
                ...
                <div class="box box-primary">
			                ...
			                <div class="modal-dialog" role="document">
			                    <div class="modal-content">
			                        <div class="modal-header">
			                            ...
			                            <h4 class="modal-title" id="myModalLabel">请假记录搜索</h4>
			                        </div>
			                        <div class="modal-body">
			                            <form id="form-search" action="${pageContext.request.contextPath}/Askoff/askoffSearch?pageNum=1&pageSize=8" target="_blank" method="post">
			                        ...
			                        <div class="modal-footer">
			                            ...
			                            <button type="button" id="btn-searchAskoff" class="btn btn-primary" >提交</button>
			                        </div>
			                    </div>
			                </div>
            			</div>
                                ...
                                <c:forEach var="askoff" items="${pageInfo.list}" varStatus="status">
                                    <tr>
                                        ...
                                        <shiro:hasRole name="人事部">
                                          <c:if test="${askoff.pass==0}">
                                          		<a type="button" id="btn-pass" href="${pageContext.request.contextPath}/Askoff/askoffPass?id=${askoff.id}&operator_id=${sessionScope.employee.eid}" class="btn btn-success  btn-xs">批准</a>
                                          </c:if>
                                         </shiro:hasRole>
                    ...
                    <div class="box-footer">
                        ...
                        <div class="box-tools pull-right">
                            <ul class="pagination">
                                <li>
                                    <a href="${pageContext.request.contextPath}/Askoff/askoffList?pageNum=${pageInfo.navigateFirstPage}&pageSize=${pageInfo.pageSize}" aria-label="Previous">首页</a>
                                </li>
                                <li><a href="${pageContext.request.contextPath}/Askoff/askoffList?pageNum=${pageInfo.prePage}&pageSize=${pageInfo.pageSize}">上一页</a></li>
                                <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
                                    <li><a href="${pageContext.request.contextPath}/Askoff/askoffList?pageNum=${pageNum}&pageSize=${pageInfo.pageSize}">${pageNum}</a></li>
                                </c:forEach>
                                <li><a href="${pageContext.request.contextPath}/Askoff/askoffList?pageNum=${pageInfo.nextPage}&pageSize=${pageInfo.pageSize}">下一页</a></li>
                                <li>
                                    <a href="${pageContext.request.contextPath}/Askoff/askoffList?pageNum=${pageInfo.navigateLastPage}&pageSize=${pageInfo.pageSize}" aria-label="Next">尾页</a>
                                </li>
                            </ul>
                        </div>
    ...
    <script>
        ...
        $('#btn-refresh').click(function(){
            var num=$('#pageNum').val();
            const  url = "${pageContext.request.contextPath}/Askoff/askoffList?pageNum="+num+"&pageSize=8";
        ...
        //搜索提交
        $('#btn-searchAskoff').click(function () {
			$('#form-search').submit();
		});
     
		//批准按钮
		$('#btn-pass').click(function () {
			window.location.href="${pageContext.request.contextPath}/Askoff/askoffPass?id=${askoff.id}&operator_id=${sessionScope.employee.eid}";
		});
