...
<div class="wrapper">
	...
	<div class="content-wrapper">
		...
		<section class="content">	
				...
				<form action="${pageContext.request.contextPath}/Employee/addEmployee" method="post" enctype="multipart/form-data">
                            ...
                            <div class="tab-pane active" id="tab-common">
                                <div class="row data-type">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="eid" name="eid" placeholder="员工身份证" required onblur="verifyeid()">
                                        <span class="glyphicon glyphicon-ok form-control-feedback" id="veid" style="display:none"></span>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="ename" name="ename" placeholder="员工姓名" required >
                                    </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 data">
										...
										<span class="input-group-addon"><i class="fa fa-mars fa-fw"></i></span>
                                            <select id="esex" name="esex" class="form-control" >
                                    ...
                                    <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="ephone" name="ephone" placeholder="员工手机号" required onblur="verifyephone()">        
                                    		<span class="glyphicon glyphicon-ok form-control-feedback" id="vephone" style="display:none"></span>
                                    </div>
                                    </div>
                                    ...
                                    <div class="input-group">
										...
										<input type="email" class="form-control" id="email" name="email"  placeholder="邮箱"  required onblur="verifyemail()">
										<span class="glyphicon glyphicon-ok form-control-feedback" id="vemail" style="display:none"></span>
                                    </div>
                                    </div>
									...
									<div class="input-group">
										...
										<input type="text" class="form-control" id="datepicker" name="em_date" placeholder="请选择" required >
									</div>
									</div>
                                    ...
                                    <div class="col-md-4 data">
            							...
            							<input type="file" name="ephotofile" id="ephotofile" required >点击这里上传照片.jpg(分辨率：128*128)
        								</a>
                                    </div>
   									<input type="hidden" name="status" value="在职" />
