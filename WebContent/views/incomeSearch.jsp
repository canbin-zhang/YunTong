...
<body class="hold-transition skin-purple sidebar-mini">
            ...
            <section class="content">
                <div class="box box-primary">
                   <div class="box-header with-border">
                        <h3 class="box-title">搜索收入记录中关键字为 “<strong style="color: purple">${keyword}</strong>” 的结果：共<strong style="color: blue">${pageInfo.getTotal()}</strong>条</h3>
                        ...
                        <div class="table-box">
                            ...
                            <table id="dataList" class="table table-bordered table-striped table-hover ">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center" id="income_date"> 收入日期</th>
                                    <th class="text-center" id="income_money"> 收入金额</th>
                    ...
                    <div class="box-footer">
                        ...
                        <div class="box-tools pull-right">
                            <ul class="pagination">
                                <li>
                                    <a href="${pageContext.request.contextPath}/Income/incomeSearch?pageNum=${pageInfo.navigateFirstPage}&pageSize=${pageInfo.pageSize}&property=${property}&keyword=${keyword}" aria-label="Previous">首页</a>
                                </li>
                                <li><a href="${pageContext.request.contextPath}/Income/incomeSearch?pageNum=${pageInfo.prePage}&pageSize=${pageInfo.pageSize}&property=${property}&keyword=${keyword}">上一页</a></li>
                                <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
                                    <li><a href="${pageContext.request.contextPath}/Income/incomeSearch?pageNum=${pageNum}&pageSize=${pageInfo.pageSize}&property=${property}&keyword=${keyword}">${pageNum}</a></li>
                                </c:forEach>
                                <li><a href="${pageContext.request.contextPath}/Income/incomeSearch?pageNum=${pageInfo.nextPage}&pageSize=${pageInfo.pageSize}&property=${property}&keyword=${keyword}">下一页</a></li>
                                <li>
                                    <a href="${pageContext.request.contextPath}/Income/incomeSearch?pageNum=${pageInfo.navigateLastPage}&pageSize=${pageInfo.pageSize}&property=${property}&keyword=${keyword}" aria-label="Next">尾页</a>
                                </li>
                            </ul>
                        </div>
    ...
    <script>
        ...
        $('#btn-refresh').click(function(){
        	 var num=$('#pageNum').val();
            const  url = "${pageContext.request.contextPath}/Income/incomeSearch?pageNum="+num+"&pageSize=8&property=${property}&keyword=${keyword}";
