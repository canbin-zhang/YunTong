...
<body class="hold-transition skin-purple sidebar-mini">
                        ...
                        <div class="table-box">
                            ...
                            <div class="pull-left">
                                <div class="form-group form-inline">
                                    <div class="btn-group">
                                        <a type="button" class="btn btn-default" title="添加" href="${pageContext.request.contextPath}/Askoff/toAddAskoff" data-toggle="modal" data-target="#myModal"><i class="glyphicon glyphicon-plus"></i> 添加 </a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                          <c:if test="${askoff.pass==0}">
		                                      ...
		                                      <a type="button" class="btn btn-danger  btn-xs" href="${pageContext.request.contextPath}/Askoff/deleteAskoff?id=${askoff.id}&eid=${sessionScope.employee.eid}" >撤销</a>
	                                      </c:if>
	                                      <c:if test="${askoff.pass==1}">
		                                      <a type="button" class="btn btn-info  btn-xs" href="${pageContext.request.contextPath}/Askoff/askoffDetail?id=${askoff.id}" data-toggle="modal" data-target="#myModal">详情</a>
                    ...
                    <div class="box-footer">
                       <div class="pull-left">
                        ...
                        <div class="box-tools pull-right">
                            <ul class="pagination">
                                <li>
                                    <a href="${pageContext.request.contextPath}/Askoff/askoffListByEid?pageNum=${pageInfo.navigateFirstPage}&pageSize=${pageInfo.pageSize}&eid=${sessionScope.employee.eid}" aria-label="Previous">首页</a>
                                </li>
                                <li><a href="${pageContext.request.contextPath}/Askoff/askoffListByEid?pageNum=${pageInfo.prePage}&pageSize=${pageInfo.pageSize}&eid=${sessionScope.employee.eid}">上一页</a></li>
                                <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
                                    <li><a href="${pageContext.request.contextPath}/Askoff/askoffListByEid?pageNum=${pageNum}&pageSize=${pageInfo.pageSize}&eid=${sessionScope.employee.eid}">${pageNum}</a></li>
                                </c:forEach>
                                <li><a href="${pageContext.request.contextPath}/Askoff/askoffListByEid?pageNum=${pageInfo.nextPage}&pageSize=${pageInfo.pageSize}&eid=${sessionScope.employee.eid}">下一页</a></li>
                                <li>
                                    <a href="${pageContext.request.contextPath}/Askoff/askoffListByEid?pageNum=${pageInfo.navigateLastPage}&pageSize=${pageInfo.pageSize}&eid=${sessionScope.employee.eid}" aria-label="Next">尾页</a>
                                </li>
                            </ul>
                        </div>
    ...
    <script>
        ...
        $('#btn-refresh').click(function(){
        	 var num=$('#pageNum').val();
            const  url = "${pageContext.request.contextPath}/Askoff/askoffListByEid?pageNum="+num+"&pageSize=8&eid=${sessionScope.employee.eid}";
