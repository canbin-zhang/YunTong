...
<body class="hold-transition skin-purple sidebar-mini">
                ...
                <div class="box box-primary">
                               ...
                               <div class="modal-dialog" role="document">
			                    <div class="modal-content">
			                        <div class="modal-header">
			                            ...
			                            <h4 class="modal-title" id="myModalLabel">支出记录搜索</h4>
			                        </div>
			                        <div class="modal-body">
			                            <form id="form-search" action="${pageContext.request.contextPath}/Disburse/disburseSearch?pageNum=1&pageSize=8" target="_blank" method="post">
		                                	<div class="form-group form-inline">
								                ...
								                <label class="radio-inline">
								                    <input type="radio"  value="disburse_date" name="property">支出时间
								                </label>
								                <label class="radio-inline">
								                    <input type="radio"  value="disburse_money" name="property">支出金额
								                </label>
								                <label class="radio-inline">
								                    <input type="radio"  value="disburse_detail" name="property">支出明细
								                </label>
			                        ...
			                        <div class="modal-footer">
			                            ...
			                            <button type="button" id="btn-searchDisburse" class="btn btn-primary" >搜索</button>
			                        </div>
			                    </div>
			                </div>
                            </div>
                    ...
                    <div class="box-footer">
                        ...
                        <div class="box-tools pull-right">
                            <ul class="pagination">
                                <li>
                                    <a href="${pageContext.request.contextPath}/Disburse/disburseList?pageNum=${pageInfo.navigateFirstPage}&pageSize=${pageInfo.pageSize}" aria-label="Previous">首页</a>
                                </li>
                                <li><a href="${pageContext.request.contextPath}/Disburse/disburseList?pageNum=${pageInfo.prePage}&pageSize=${pageInfo.pageSize}">上一页</a></li>
                                <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
                                    <li><a href="${pageContext.request.contextPath}/Disburse/disburseList?pageNum=${pageNum}&pageSize=${pageInfo.pageSize}">${pageNum}</a></li>
                                </c:forEach>
                                <li><a href="${pageContext.request.contextPath}/Disburse/disburseList?pageNum=${pageInfo.nextPage}&pageSize=${pageInfo.pageSize}">下一页</a></li>
                                <li>
                                    <a href="${pageContext.request.contextPath}/Disburse/disburseList?pageNum=${pageInfo.navigateLastPage}&pageSize=${pageInfo.pageSize}" aria-label="Next">尾页</a>
                                </li>
                            </ul>
                        </div>
    ...
    <script>
        ...
        $('#btn-refresh').click(function(){
        	 var num=$('#pageNum').val();
            const  url = "${pageContext.request.contextPath}/Disburse/disburseList?pageNum="+num+"&pageSize=8";
        ...
        //搜索提交
        $('#btn-searchDisburse').click(function () {
			$('#form-search').submit();
		});
