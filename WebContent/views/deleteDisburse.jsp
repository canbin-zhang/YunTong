...
<body>
	...
	<section class="content">	
		<div class="tab-content">	
				<form id="form" action="${pageContext.request.contextPath}/Disburse/deleteDisburse" method="post">
					 <input type="hidden" name="id" value="${disburse.id}">
    ...
    <div class="modal-footer">
        <button type="button" id="btn-deleteDisburse"class="btn btn-danger">删除</button>
    </div>
    ...
    <script type="text/javascript">
        ...
        $("#btn-deleteDisburse").click(function () {
			$("#form").submit();
		})
    </script>
</body>
