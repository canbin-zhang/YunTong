...
<body>
	...
	<section class="content">	
		<div class="tab-content">	
				<form id="form-updateNotice" action="${pageContext.request.contextPath}/Notice/updateNotice" method="post" enctype="multipart/form-data">
								...
								<div class="col-md-12 data">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="datepicker" name="date" 
                                        	   value="<fmt:formatDate value='${notice.date}' type='date' pattern='yyyy-MM-dd'/>" />
                                    </div>
									</div>
                                    ...
                                    <div class="input-group">
										<a href="javascript:;" class="a-upload">
            								<input type="file" name="nphotofile" id="nphotofile">点击这里上传文件
        								</a>   
                                    </div>
									</div>
                                    ...
                                    <div class="input-group">
										...
										<input type="text" class="form-control"  id="detail" name="detail" value="${notice.detail}" maxlength="50" onblur="verifyDetail()"/>
									</div>
									</div>
    ...
    <div class="modal-footer">
        ...
        <button type="button" id="btn-updateNotice" class="btn btn-primary" data-dismiss="modal">提交</button>
    </div>
    ...
    $('#btn-updateNotice').click(function () {
      	$('#form-updateNotice').submit();
	});
