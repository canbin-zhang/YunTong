...
<body class="hold-transition skin-purple sidebar-mini">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-footer">
                        ...
                        <div class="box-tools pull-right">
                            <ul class="pagination">
                                <li>
                                    <a href="${pageContext.request.contextPath}/Student/toStudentList?pageNum=${pageInfo.navigateFirstPage}&pageSize=${pageInfo.pageSize}" aria-label="Previous">首页</a>
                                </li>
                                <li><a href="${pageContext.request.contextPath}/Student/toStudentList?pageNum=${pageInfo.prePage}&pageSize=${pageInfo.pageSize}">上一页</a></li>
                                <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
                                    <li><a href="${pageContext.request.contextPath}/Student/toStudentList?pageNum=${pageNum}&pageSize=${pageInfo.pageSize}">${pageNum}</a></li>
                                </c:forEach>
                                <li><a href="${pageContext.request.contextPath}/Student/toStudentList?pageNum=${pageInfo.nextPage}&pageSize=${pageInfo.pageSize}">下一页</a></li>
                                <li>
                                    <a href="${pageContext.request.contextPath}/Student/toStudentList?pageNum=${pageInfo.navigateLastPage}&pageSize=${pageInfo.pageSize}" aria-label="Next">尾页</a>
                                </li>
                            </ul>
                        </div>
    ...
    <script>
        ...
        $('#btn-refresh').click(function(){
        	 var num=$('#pageNum').val();
            const  url = "${pageContext.request.contextPath}/Student/toStudentList?pageNum="+num+"&pageSize=8";
